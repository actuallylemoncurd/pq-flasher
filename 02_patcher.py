...
patches = {
    ...
    "3501Torque": [
        ...
        # Booooooooooooost
        (0x0005E669, b"\x58", b"\x71"),  #hca_lm_offset_torque_handler
        (0x0005E66A, b"\x71", b"\x9B"),
        #(0x0005E66B, b"\x9B", b"\xFF"),
        (0x0005E671, b"\x58", b"\x71"),
        (0x0005E672, b"\x71", b"\x9B"),
        #(0x0005E673, b"\x9B", b"\xFF"),
        (0x0005E679, b"\x58", b"\x71"),
        (0x0005E67A, b"\x71", b"\x9B"),
        #(0x0005E67B, b"\x9B", b"\xFF"),
        # FUN_00029272 maps
        (0x0005E4A8, b"\x02", b"\xC0"),  # 0005e0a8 map
        (0x0005E4AA, b"\x20", b"\xC0"),
        (0x0005E4AC, b"\xC0\x00", b"\x85\x04"),
        (0x0005E4AE, b"\x86\x01", b"\x85\x04"),
        (0x0005E4B0, b"\x9E\x02", b"\x19\x05"),
        (0x0005E4B2, b"\xAC\x03", b"\x19\x05"),
        (0x0005E4B4, b"\x85\x04", b"\x78\x05"),
        (0x0005E4B6, b"\x19\x05", b"\x78\x05"),
        #(0x0005E4B8, b"\x78\x05", b"\xF0\x0A"),
        (0x0005E4D4, b"\x02", b"\xC0"),
        (0x0005E4D6, b"\x20", b"\xC0"),
        (0x0005E4D8, b"\xC0\x00", b"\x85\x04"),
        (0x0005E4DA, b"\x86\x01", b"\x85\x04"),
        (0x0005E4DC, b"\x9E\x02", b"\x19\x05"),
        (0x0005E4DE, b"\xAC\x03", b"\x19\x05"),
        (0x0005E4E0, b"\x85\x04", b"\x78\x05"),
        (0x0005E4E2, b"\x19\x05", b"\x78\x05"),
        #(0x0005E4E4, b"\x78\x05", b"\xF0\x0A"),
        (0x0005E500, b"\x02", b"\xC0"),
        (0x0005E502, b"\x20", b"\xC0"),
        (0x0005E504, b"\xC0\x00", b"\x85\x04"),
        (0x0005E506, b"\x86\x01", b"\x85\x04"),
        (0x0005E508, b"\x9E\x02", b"\x19\x05"),
        (0x0005E50A, b"\xAC\x03", b"\x19\x05"),
        (0x0005E50C, b"\x85\x04", b"\x78\x05"),
        (0x0005E50E, b"\x19\x05", b"\x78\x05"),
        #(0x0005E510, b"\x78\x05", b"\xF0\x0A"),

        #(0x0005E52E, b"\x80\x00", b"\x00\x01"),  # 0005e0cc map
        (0x0005E530, b"\x78\x00", b"\x80\x00"),
        (0x0005E532, b"\x57\x00", b"\x80\x00"),
        (0x0005E534, b"\x3D\x00", b"\x78\x00"),
        (0x0005E536, b"\x27\x00", b"\x78\x00"),
        (0x0005E538, b"\x1A\x00", b"\x57\x00"),
        #(0x0005E54A, b"\x80\x00", b"\x00\x01"),
        (0x0005E54C, b"\x78\x00", b"\x80\x00"),
        (0x0005E54E, b"\x57\x00", b"\x80\x00"),
        (0x0005E550, b"\x3D\x00", b"\x78\x00"),
        (0x0005E552, b"\x27\x00", b"\x78\x00"),
        (0x0005E554, b"\x1A\x00", b"\x57\x00"),
        #(0x0005E566, b"\x80\x00", b"\x00\x01"),
        (0x0005E568, b"\x78\x00", b"\x80\x00"),
        (0x0005E56A, b"\x57\x00", b"\x80\x00"),
        (0x0005E56C, b"\x3D\x00", b"\x78\x00"),
        (0x0005E56E, b"\x27\x00", b"\x78\x00"),
        (0x0005E570, b"\x1A\x00", b"\x57\x00"),

        #(0x0005E582, b"\x00\x04", b"\x00\x08"),  # 0005e0d8 map
        (0x0005E584, b"\xCD\x03", b"\x00\x04"),
        (0x0005E586, b"\x14\x03", b"\x00\x04"),
        (0x0005E588, b"\x7B\x02", b"\xCD\x03"),
        (0x0005E58A, b"\x00\x02", b"\xCD\x03"),
        (0x0005E58C, b"\x91\x01", b"\x14\x03"),
        #(0x0005E59E, b"\x00\x04", b"\x00\x08"),
        (0x0005E5A0, b"\xCD\x03", b"\x00\x04"),
        (0x0005E5A2, b"\x14\x03", b"\x00\x04"),
        (0x0005E5A4, b"\x7B\x02", b"\xCD\x03"),
        (0x0005E5A6, b"\x00\x02", b"\xCD\x03"),
        (0x0005E5A8, b"\x91\x01", b"\x14\x03"),
        #(0x0005E5BA, b"\x00\x04", b"\x00\x08"),
        (0x0005E5BC, b"\xCD\x03", b"\x00\x04"),
        (0x0005E5BE, b"\x14\x03", b"\x00\x04"),
        (0x0005E5C0, b"\x7B\x02", b"\xCD\x03"),
        (0x0005E5C2, b"\x00\x02", b"\xCD\x03"),
        (0x0005E5C4, b"\x91\x01", b"\x14\x03"),

        (0x0005E5DC, b"\x1A", b"\x75"),  # 0005e0fc map
        (0x0005E5DD, b"\x40", b"\x7F"),
        (0x0005E5DE, b"\x62", b"\x7F"),
        (0x0005E5DF, b"\x75", b"\x93"),
        (0x0005E5E0, b"\x7F", b"\x93"),
        #(0x0005E5E1, b"\x93\x00", b"\x26\x01"),
        (0x0005E5EC, b"\x1A", b"\x75"),
        (0x0005E5ED, b"\x40", b"\x7F"),
        (0x0005E5EE, b"\x62", b"\x7F"),
        (0x0005E5EF, b"\x75", b"\x93"),
        (0x0005E5F0, b"\x7F", b"\x93"),
        #(0x0005E5F1, b"\x93\x00", b"\x26\x01"),
        (0x0005E5FC, b"\x1A", b"\x75"),
        (0x0005E5FD, b"\x40", b"\x7F"),
        (0x0005E5FE, b"\x62", b"\x7F"),
        (0x0005E5FF, b"\x75", b"\x93"),
        (0x0005E600, b"\x7F", b"\x93"),
